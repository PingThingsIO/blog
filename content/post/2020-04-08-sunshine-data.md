---
title: "Sunshine Data"
date: 2020-04-07T12:30:37-0400
description: "A brief walkthrough of the Sunshine dataset"
tags: ["btrdb", "timeseries", "python", "sunshine data", "pmu"]
---
# Sunshine Data

[contextual information about the data set, etc.]
...
We also import the `tabulate` function which we will use to create nicely formatted reports as well as the pandas library so we can turn the data into a `pandas.Series` object.
...
We've seen how we can view collections, streams, and data but there is much more you can do with BTrDB and Python!  Check out our [tutorials and walkthroughs](https://btrdb.readthedocs.io/en/latest/working.html) to see more.